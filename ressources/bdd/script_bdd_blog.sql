...
-- -----------------------------------------------------
CREATE DATABASE
IF NOT EXISTS bdd_blog_php DEFAULT CHARACTER
SET utf8 ;
USE bdd_blog_php
;
...
(255) NULL,
  ...
  PRIMARY KEY
(id_post, title, create_date),
  UNIQUE INDEX title_UNIQUE
(title ASC),
  INDEX fk_Post_User_id
(User_id_user ASC),
...
(
  ...
  PRIMARY KEY
(id_comment),
  INDEX fk_Comment_Status_id
(Status_id_status ASC),
  INDEX fk_Comment_Post_id
(Post_id_post ASC),
  INDEX fk_Comment_User_id
(User_id_user ASC),
